...
void Game::CreateWorld()
{
	...
	regions.MakeShaftLinks( 2, 3, 8 );
	regions.MakeShaftLinks( 2, 4, 8 );
	regions.MakeShaftLinks( 3, 4, 8 );
	//shafts from underdeeps to deeper underdeeps
	regions.MakeShaftLinks( 5, 6, 8 );
	regions.MakeShaftLinks( 5, 6, 8 );
	regions.MakeShaftLinks( 6, 7, 8 );
	//shafts from deepest underworld to deepest underdeeps
	regions.MakeShaftLinks( 4, 7, 8 );
