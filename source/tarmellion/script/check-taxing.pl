...
if ($ARGV[0] ne ""){
	if ($ARGV[0] eq "friendly"){
		@factions = (15, 16, 20, 21, 22, 25, 26, 29, 30, 33, 40, 41, 44, 45, 46, 49, 56, 57, 58, 61, 64, 65, 69, 71, 78, 80, 81, 88, 91, 93, 96, 99, 100, 104, 105, 106, 107, 110, 111, 120, 126, 129, 131, 137, 138, 143, 144, 149, 160, 171, 173, 180, 188, 196, 197, 200, 204, 205, 213, 214, 220, 228, 232, 237, 238, 242, 246, 274, 286, 290);
	} else {
		@factions = ($ARGV[0]);
	}
}
